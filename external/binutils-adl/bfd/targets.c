...
extern const bfd_target adl_elf32_vec;
extern const bfd_target adl_elf32_le_vec;
extern const bfd_target adl_elf64_vec;
extern const bfd_target adl_elf64_le_vec;
...
// But this is overridden by ADL's code, so we don't make it constant or static.
