...
VCPU_FILE=as-vcpu3_spec
IPPU_FILE=as-ippu3_spec
OUTPUT_NAME=vspa3-as
OUTPUT_FOLDER=vspa3
endif

INCLUDE_PATH=-I"." -I"./external/binutils-adl/gas" -I"./external/binutils-adl/gas/config" -I"./external/binutils-adl/win-build/gas" -I"./external/binutils-adl/opcodes" -I"./external/binutils-adl/win-build/opcodes" -I"./external/binutils-adl/bfd" -I"./external/binutils-adl/win-build/bfd" -I"./external/binutils-adl/win-build/"  -I"./external/binutils-adl/include" -I"./external/binutils-adl/" -I"../enterprise_tools/target" #-I"./external/binutils-adl/win-headers"
...
bin/$(OUTPUT_FOLDER)/$(OUTPUT_NAME): bin/$(OUTPUT_FOLDER)/assembler/$(VCPU_FILE).o bin/$(OUTPUT_FOLDER)/assembler/$(IPPU_FILE).o bin/$(OUTPUT_FOLDER)/assembler/objdump-vcpu3_spec.o bin/$(OUTPUT_FOLDER)/libgas/libgas.a bin/$(OUTPUT_FOLDER)/libiberty/libiberty.a bin/$(OUTPUT_FOLDER)/libopcode/libopcode.a bin/$(OUTPUT_FOLDER)/libbfd/libbfd.a
	$(CPP_COMPILER) $^ $(LIBRARY_PATH) $(LIRARIES) $(COMPILER_FLAGS) -static -Wl,-rpath,./ -o $@                                              

bin/$(OUTPUT_FOLDER)/assembler/as-vcpu3_spec.o: assembler/as-vcpu3_spec.cc
	$(CPP_COMPILER) $(PREPROCESSOR_DEFINITIONS) -c $< $(INCLUDE_PATH) $(COMPILER_FLAGS) -o $@

bin/$(OUTPUT_FOLDER)/assembler/as-ippu3_spec.o: assembler/as-ippu3_spec.cc
	$(CPP_COMPILER) $(PREPROCESSOR_DEFINITIONS) -c $< $(INCLUDE_PATH) $(COMPILER_FLAGS) -o $@
  
bin/$(OUTPUT_FOLDER)/assembler/objdump-vcpu3_spec.o: assembler/objdump-vcpu3_spec.cc
	$(CPP_COMPILER) $(PREPROCESSOR_DEFINITIONS) -c $< $(INCLUDE_PATH) $(COMPILER_FLAGS) -o $@
