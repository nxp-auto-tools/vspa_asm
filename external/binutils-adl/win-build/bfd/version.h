#define VSPA_ADL_VERSION "1.181"

// 1.181
//  Bugfix CMPVSPA-2910, CMPVSPA-3038: Relax assembler checks for hw errata
//  Relax assembler checks for hw errata ERR011359 / VSPA A-011359
// 1.180
//  Bugfix CMPVSPA-2982, CMPVSPA-2984: Fix issues in assembler checker for hw
//  issues for vspa2
//  Fix issues in assembler checker for hw issues for vspa2
// 1.179
//  Bugfix CMPVSPA-2910, CMPVSPA-2892: Add assembler checks for hw errata
//  Add assembler checks for hw errata ERR011359 / VSPA A-011359 and ERR011386 /
//  VSPA A-011386
// 1.178
//  Bugfix CMPVSPA-1690, CMPVSPA-1693: Don't dump low_pc and high_pc in debug
//  info if we don't have a text section
//  Don't dump low_pc and high_pc in debug info if we don't have a text section
//  or we have an empty one on vspa2
// 1.177
//  CAF
//  Cleanup of unused binary files for pushing into CAF
//  Bugfix CMPVSPA-2484 CMPVSPA-2508: Update alignment size inVSPA2 assembler
//  Update alignment size for sections in VSPA2 assembler; also updated .git_ignore
//  to also ignore vspa3 configuration folders
// 1.176
