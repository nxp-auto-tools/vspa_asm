...
INCLUDE_PATH=-I"./external/binutils-adl/gas" -I"./external/binutils-adl/gas/config" -I"./external/binutils-adl/win-build/gas" -I"./external/binutils-adl/" -I"./external/binutils-adl/include" -I"./external/binutils-adl/bfd" -I"./external/binutils-adl/win-build/bfd" #-I"./external/binutils-adl/win-headers"
