...
#
# The PLT-agnostic parts of a generic 32-bit ELF ADL target.  Included by:
# elf32adl.sh elf64adl.sh
TEMPLATE_NAME=elf32
GENERATE_SHLIB_SCRIPT=no
GENERATE_PIE_SCRIPT=no
EMBEDDED=yes
SCRIPT_NAME=elf
OUTPUT_FORMAT="elf32-adl"
NO_REL_RELOCS=yes
...
"
EXTRA_EM_FILE=adlelf
GENERATE_ACB_OPTION_HOOK=yes
