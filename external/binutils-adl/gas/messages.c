...
void
as_vtsktsk (const char *format, va_list args)
{
  as_show_where ();
...
void
as_vwarn (const char *format, va_list args)
{
  char buffer[2000];
...
void
as_vwarn_where (char *file, unsigned int line, const char *format, va_list args)
{
  char buffer[2000];
...
void
as_vbad_where (char *file, unsigned int line, const char *format, va_list args)
{
  char buffer[2000];
...
void
as_vfatal (const char *format, va_list args)
{
  as_show_where ();
