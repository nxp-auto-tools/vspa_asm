...
#ifdef BFD64
#if !defined (SELECT_VECS) || defined (HAVE_adl_elf64_vec)

{ "adl64-*-elf*", NULL },{ "adl-*-elf64*",
&adl_elf64_vec },
#endif


		
#if !defined (SELECT_VECS) || defined (HAVE_adl_elf64_le_vec)

{ "adl64le-*-elf*", NULL },{ "adlle-*-elf64*",
&adl_elf64_le_vec },
#endif
...
#endif
#if !defined (SELECT_VECS) || defined (HAVE_adl_elf32_vec)

{ "adl-*-elf*", NULL },{ "adl-*-elf32*",
&adl_elf32_vec },
#endif


		
#if !defined (SELECT_VECS) || defined (HAVE_adl_elf32_le_vec)

{ "adlle-*-elf*", NULL },{ "adlle-*-elf32*",
&adl_elf32_le_vec },
#endif
