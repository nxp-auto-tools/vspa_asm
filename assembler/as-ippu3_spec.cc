...
struct ippu_local_instr_attrs : public adl_instr_attrs {
  ippu_local_instr_attrs(uint64_t a,const adl_instr_attr_val *vals) : adl_instr_attrs(vals), _attrs(a) {};
  ippu_local_instr_attrs(const char *a,const adl_instr_attr_val *vals) : adl_instr_attrs(vals), _attrs(a) {};
...
static struct adl_field adl_operands [] = {
  ...
  {"IM16R16_width_32",31,31,16,set_IM16R16_width_32,clear_IM16R16_width_32,0,-1,(BFD_RELOC_UNUSED + 2),0,-1,0,0,0},	// 31
  {"IM19s",32,32,19,0,0,0,-1,-1,0,-1,0,0,0},	// 32
  {"IM19sR17",33,33,19,0,0,0,-1,(BFD_RELOC_UNUSED + 1),0,-1,0,0,0},	// 33
  {"IM19sR17_imp_bits__3_3_x_21_4__width_32",33,33,19,set_IM19sR17_imp_bits__3_3_x_21_4__width_32,clear_IM19sR17_imp_bits__3_3_x_21_4__width_32,0,-1,(BFD_RELOC_UNUSED + 1),0,-1,0,0,0},	// 34
...
static const int num_adl_operands = 96;
...
static const int num_adl_operands_by_index = 51;
...
static ippu_local_instr_attrs _sym85 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym88 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym91 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym94 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
// Instruction clr_Rx
static ippu_local_instr_attrs _sym97 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
// Instruction clr_all
static ippu_local_instr_attrs _sym100 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym105 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym108 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
// Instruction cmp_bit
static ippu_local_instr_attrs _sym111 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
// Instruction done
static ippu_local_instr_attrs _sym114 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
// Instruction jmp
static ippu_local_instr_attrs _sym117 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
// Instruction jsr
static ippu_local_instr_attrs _sym120 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym123 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym126 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym129 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym132 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym135 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym138 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym141 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym144 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym147 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym150 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym153 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym156 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym159 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym162 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
// Instruction nop
static ippu_local_instr_attrs _sym165 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
// Instruction rts
static ippu_local_instr_attrs _sym168 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym171 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym174 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym177 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
// Instruction set_er
static ippu_local_instr_attrs _sym180 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym183 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym186 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym192 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym197 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym200 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym203 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym206 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym209 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym212 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym215 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym218 { ((uint64_t)(1ULL << instr_ippu)) , nullptr };
...
static ippu_local_instr_attrs _sym221 { ((uint64_t)(1ULL << instr_loop_begin)) , nullptr };

// Instruction loop_begin_0
static struct enum_fields *_sym223[] = {  (struct enum_fields *) -1,};

// Instruction loop_begin_1
static ippu_local_instr_attrs _sym224 { ((uint64_t)(1ULL << instr_loop_begin)) | ((uint64_t)(1ULL << instr_loop_1)) , nullptr };

// Instruction loop_begin_1
static struct enum_fields *_sym226[] = {  (struct enum_fields *) -1,};

// Instruction loop_end_0
static ippu_local_instr_attrs _sym227 { ((uint64_t)(1ULL << instr_loop_end)) , nullptr };

// Instruction loop_end_0
static struct enum_fields *_sym229[] = {  (struct enum_fields *) -1,};

// Instruction loop_end_1
static ippu_local_instr_attrs _sym230 { ((uint64_t)(1ULL << instr_loop_end)) | ((uint64_t)(1ULL << instr_loop_1)) , nullptr };
...
static const int num_adl_regnames = 10;
...
static reloc_howto_type adl_elf_howto_table[] = {
  HOWTO(17,0,3,19,0,0,complain_overflow_signed,bfd_elf_generic_reloc,(char*)"R_IPPU_DMEM_19",0,0x0,0x7ffff,0), // relocation R_IPPU_DMEM_19 (R_IPPU_DMEM_19)
  HOWTO(16,2,1,16,0,0,complain_overflow_unsigned,bfd_elf_generic_reloc,(char*)"R_IPPU_PRAM_16",0,0x0,0xffff,0), // relocation R_IPPU_PRAM_16 (R_IPPU_PRAM_16)
  EMPTY_HOWTO(-1)
};

static unsigned num_adl_elf_howtos ATTRIBUTE_UNUSED = 3;

// Relocations ordered by name, for fast name -> type searches.
static struct adl_reloc_name adl_relocs_by_index [] = {
   { "R_IPPU_DMEM_19", 0, (BFD_RELOC_UNUSED + 1), 34, false }, // R_IPPU_DMEM_19
   { "R_IPPU_PRAM_16", 1, (BFD_RELOC_UNUSED + 2), 31, false }, // R_IPPU_PRAM_16
};

static const int num_adl_relocs_by_index = 2;
...
{
  adl_assemble(str,instr_hash[internal_current_table],asm_instr_hash,reg_hash,instr_pfx_fields_hash,11,internal_current_table,adl_itnames[internal_current_table]);
}
...
extern "C" reloc_howto_type *ippu_adl_get_howto_array(unsigned *num_howtos)
{
  *num_howtos = num_adl_elf_howtos - 1;
  return adl_elf_howto_table;
}


extern "C" reloc_howto_type *ippu_adl_elf_type_to_howto(unsigned r)
{
  switch (r) {
    case 17:
    return &adl_elf_howto_table[0];
    case 16:
    return &adl_elf_howto_table[1];
  }
  return 0;
}

extern "C" reloc_howto_type *ippu_adl_bfd_code_to_howto(bfd_reloc_code_real_type code)
{
  switch (code) {
    case (BFD_RELOC_UNUSED + 2):
    return &adl_elf_howto_table[1];
    case (BFD_RELOC_UNUSED + 1):
    return &adl_elf_howto_table[0];
    default:
    return 0;
  }
