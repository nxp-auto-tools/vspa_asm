...
INCLUDE_PATH=-I"." -I"./external/binutils-adl/gas" -I"./external/binutils-adl/gas/config" -I"./external/binutils-adl/win-build/gas" -I"./external/binutils-adl/opcodes" -I"./external/binutils-adl/win-build/opcodes" -I"./external/binutils-adl/bfd" -I"./external/binutils-adl/win-build/bfd" -I"./external/binutils-adl/win-build/"  -I"./external/binutils-adl/include" -I"./external/binutils-adl/" #-I"./external/binutils-adl/win-headers"
