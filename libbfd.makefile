...
PREPROCESSOR_DEFINITIONS=$(VSPA_VERSION) -DHAVE_powerpc_elf64_vec -DHAVE_powerpc_elf64_le_vec -DHAVE_powerpc_elf32_vec -DHAVE_powerpc_elf32_le_vec -DHAVE_elf64_le_vec -DHAVE_elf64_be_vec -DHAVE_elf32_le_vec -DHAVE_elf32_be_vec -DHAVE_CONFIG_H -DDEBUGDIR=\"C:\\Debug\" -DDEFAULT_VECTOR=powerpc_elf64_vec -DSELECT_VECS="&powerpc_elf64_vec,&powerpc_elf64_le_vec,&powerpc_elf32_vec,&powerpc_elf32_le_vec,&elf64_le_vec,&elf64_be_vec,&elf32_le_vec,&elf32_be_vec" -DSELECT_ARCHITECTURES="&bfd_rs6000_arch,&bfd_powerpc_arch" -DGCC_BUILD #-D__USE_MINGW_FSEEK
COMPILER_FLAGS=
