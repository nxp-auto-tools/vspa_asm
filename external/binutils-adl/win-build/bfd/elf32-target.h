...
extern bfd_boolean adl_section_processing(bfd *abfd, Elf_Internal_Shdr *hdr);
#undef elf_backend_section_processing

extern bfd_boolean adl_elf_make_object(bfd *abfd);
...
#define bfd_elf32_mkobject adl_elf_make_object
#endif
...
#define elf_backend_section_processing	adl_section_processing
#endif
...
#define elf_backend_section_from_bfd_section	adl_backend_section_from_bfd_section
#endif
...
#define elf_backend_final_write_processing	adl_final_write_processing
#endif
